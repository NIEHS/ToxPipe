...
try:
    ...
    storage_context = StorageContext.from_defaults(persist_dir='./storage/companies')
    # load index
    index = load_index_from_storage(storage_context, index_id="companies")
except:
    ...
    # save index to disk
    index.set_index_id("companies")
    index.storage_context.persist('./storage/companies')
