...
For data storage and retrieval, ToxPipe utilizes a combination of vector databases and traditional relational databases. Weaviate serves as the primary vector database, enabling efficient storage and retrieval of high-dimensional embeddings generated from toxicological data and documents. This allows for semantic search capabilities, enhancing the system's ability to find relevant information quickly. PostgreSQL is employed as the relational database, storing structured data such as chemical properties, experimental results, and metadata.

To facilitate data integration and API management, ToxPipe incorporates NocoDB, a no-code platform that provides a user-friendly interface for database management and API creation. This allows for easy creation of custom tables, views, and APIs without extensive coding, enhancing the flexibility and extensibility of the ToxPipe ecosystem.

For workflow automation and integration of various components, n8n is utilized. This powerful workflow automation tool enables the creation of complex, multi-step processes that can incorporate data from various sources, trigger actions based on specific events, and automate repetitive tasks within the ToxPipe environment.
