...
For process of spinning off multiple agents, the evaluation metrics used include a "confidence rating", defined as the number of agents that returned that piece of information divided by the total number of agents, {n_agents} and formatted as a percentage.
